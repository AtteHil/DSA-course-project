...
if __name__ == "__main__":
    ...
    table.printtable()
    print("Value -12456 was found?:", table.search(-12456))
    print("Value hashtable was found?:", table.search('hashtable'))
    print("Value aaaabbbbcccc was found?:", table.search('aaaabbbbcccc'))
    print("Removing values BM40A1500, 1234 and aaaabbbbcccc")
